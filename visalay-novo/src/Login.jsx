...
export default function Login({ 
  ...
  cpfSuperAdmin, setCpfSuperAdmin, senhaSuperAdmin, setSenhaSuperAdmin, entrarComoSuperAdmin
}) {
        ...
        <div style={{ backgroundColor: '#fff', padding: '30px', borderRadius: '8px', boxShadow: '0 4px 20px rgba(0,0,0,0.08)', width: '100%', maxWidth: '380px', borderTop: `5px solid ${TSEA.vermelho}`, textAlign: 'center' }}>
          ...
          {perfil === 'superadmin' && (
            <div>
              ...
              <input type="text" placeholder="CPF do Administrador" value={cpfSuperAdmin} onChange={(e) => setCpfSuperAdmin(e.target.value)} style={{ width: '100%', padding: '12px', borderRadius: '6px', border: `1px solid ${TSEA.cinzaMedio}`, textAlign: 'center', marginBottom: '10px', boxSizing: 'border-box' }} />
